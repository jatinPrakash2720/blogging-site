...
const Menubar = ShadcnMenubar;
const MenubarMenu = ShadcnMenubarMenu;
const MenubarTrigger = ShadcnMenubarTrigger;
const MenubarContent = ShadcnMenubarContent;
...
const MenubarPortal = ShadcnMenubarPortal;
...
const MenubarGroup = ShadcnMenubarGroup;
