...
// import HorizoneHeader from "@/components/layout/HorizoneHeader";
...
//       <HorizoneHeader onHeightChange={setHeaderHeight} />
//       <div
//         className="relative flex-grow w-full"
//         style={{ paddingTop: `${headerHeight}px` }}
//       >
//         <main className="container max-w-[95%] mx-auto px-4 py-8">
...
//                 <FeatureBar
//                   items={[
//                     { slug: "All", label: "All", icon: Home },
//                     {
//                       slug: "Destination",
//                       label: "Destination",
//                       icon: Compass,
//                     },
//                     { slug: "Culinary", label: "Culinary", icon: Tag },
//                     { slug: "Lifestyle", label: "Lifestyle", icon: Tag },
//                     { slug: "Tips & Hacks", label: "Tips & Hacks", icon: Tag },
//                   ]}
...
//                 items={[
//                   { slug: "All", label: "All", icon: Home },
//                   { slug: "Destination", label: "Destination", icon: Compass },
//                   { slug: "Culinary", label: "Culinary", icon: Tag },
//                   { slug: "Lifestyle", label: "Lifestyle", icon: Tag },
//                   { slug: "Tips & Hacks", label: "Tips & Hacks", icon: Tag },
//                 ]}
